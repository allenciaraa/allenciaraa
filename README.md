...
Software engineer with an M.S. in Computer Science (Big Data Systems) and B.S. in Software Engineering from Arizona State University. I work across full-stack web, mobile, applied ML, and security.

## What I work with

**Languages:** Python, Java, JavaScript, SQL  
**Frontend / Mobile:** React, React Native, Figma  
**Backend:** Node.js, Express, Firebase, MongoDB, MySQL  
**ML / Data:** pandas, scikit-learn, PyTorch, NumPy, matplotlib  
**Security:** CompTIA Security+, 100+ pwn.college CTFs  
**Other:** AWS (EC2), Git, Solidity / Ethereum, Unix/Linux
...
Looking for software engineering roles (full-stack, backend, or security-adjacent) in the Bay Area or remote.

---

_Open to connecting — feel free to reach out via [LinkedIn](https://linkedin.com/in/ciaraallen)_
